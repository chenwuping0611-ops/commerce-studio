...
from applications.view.studio import register_studio_views
from applications.view.amazon_ai import register_amazon_ai_views
...
def init_view(app):
    ...
    register_studio_views(app)
    register_amazon_ai_views(app)
